...
This file preserves the previous website-style repository README for historical
reference. It includes MATLAB-era installation notes and transitional
modernization notes that may no longer describe the current mainline layout.
For current setup and usage, start with the root `README.md`.
...
3. Open and run `legacy/matlab/Main_GUI.m`.
