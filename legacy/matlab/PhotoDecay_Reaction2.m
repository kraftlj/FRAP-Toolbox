...
p0=[.9,usrinputs{6,1}]; % Define the initial fitting parameters
% solve the non-linear least squares problem
p=lsqcurvefit(fun,p0,t(usrinputs{8,1}:usrinputs{8,2},1),f(usrinputs{8,1}:usrinputs{8,2}),[0,usrinputs{6,2}],[2,usrinputs{6,3}],options);
decayrate=p(2);
for index1=1:length(val)
